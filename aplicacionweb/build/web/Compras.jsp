...
<%@page import="modelo.proveedores_list"%>
...
<html>
    ...
    <body>
        <h1>Formulario Compras</h1>
            <div id="contenido">
                <br>
            <form action="srv_compras" method="POST" class="form-group">
                ...
                <select name="Drop_clientes" id="Drop_clientes" class="form-control">   
                    <%
                        proveedores_list tcliente = new proveedores_list();
                        tcliente= new proveedores_list();
