...
public class srv_clientes_operaciones extends HttpServlet {
    cliente cli;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet srv_clientes_operaciones</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if ("agregar".equals(request.getParameter("btn_agregar"))){
                if (cli.agregar()>0){
                    response.sendRedirect("Clientes_operaciones.jsp");
                    out.println("<h1> *** Ingreso Exitoso*** </h1>");
                    out.println("<a href='Clientes_operaciones.jsp'>Regresar...</a>");
                }else{
...
//            out.println("<h1>Servlet srv_clientes_operaciones at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
