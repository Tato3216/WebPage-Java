...
public class srv_usuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet srv_usuario</title>");            
            out.println("</head>");
            out.println("<body>");
            us= new usuario(Integer.valueOf(request.getParameter("Drop_Nivel")),request.getParameter("txt_name"),request.getParameter("txt_user"),request.getParameter("txt_pass"));
...
//            out.println("<h1>Servlet srv_usuario at " + request.getContextPath() + "</h1>");
